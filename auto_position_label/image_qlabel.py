...
from auto_position_label.utils import Cluster
from auto_position_label.crop_position import screen_position


class Image_QLabel(QtWidgets.QLabel):
    image_name = 'D:/github_project/auto_press_down_gun/auto_position_label/pos1.png'
        ...
        if self.mid_mode:
            ...
            if ev.buttons() == Qt.RightButton:
                if not self.before_choose_one:
                    ...
                    self.set_res_rect_n(self.res_rect_n-1)
                    self.res_rects[self.res_rect_n] = [0, 0, 0, 0]
    ...
    def print_res(self):
        ...
        print('\n')
        for k, v in cluster.c_dict.items():
            print("'"+k+"': " + str(v) + ',')
